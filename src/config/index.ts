...
export const NODE_ENV = process.env.NODE_ENV ? (process.env.NODE_ENV as string)  : "";
...
export const DB_PASSWORD: string = process.env.DB_PASSWORD ? process.env.DB_PASSWORD: "";
